...
public class Robot implements Competitors {
    ...
    public void run(int distance) {
        if (distance <= maxRunDistance){
            ...
            System.out.println("Робот " + name + " не смог пробежать " + distance + " метров и сошел с дистанции");
            isOnDistance = false;
        }
    }
    ...
    public void jump(int height) {
        if (height <= maxJumpHeight){
            System.out.println("Робот " + name + " успешно прыгнул на " + height + " метров");
        }
        else {
            System.out.println("Робот " + name + " не смог прыгнуть на " + height + " метров и сошел с дистанции");
            isOnDistance = false;
        }
    }
}
