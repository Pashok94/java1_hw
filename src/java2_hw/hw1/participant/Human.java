...
public class Human implements Competitors {
    ...
    public void run(int distance) {
        if (distance <= maxRunDistance){
            ...
            System.out.println("Человек " + name + " не смог пробежать " + distance + " метров и сошел с дистанции");
            isOnDistance = false;
        }
    }
    ...
    public void jump(int height) {
        if (height <= maxJumpHeight){
            System.out.println("Человек " + name + " успешно прыгнул на " + height + " метров");
        }
        else {
            System.out.println("Человек " + name + " не смог прыгнуть на " + height + " метров и сошел с дистанции");
            isOnDistance = false;
        }
    }
}
